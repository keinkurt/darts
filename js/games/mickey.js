    ...
    global.Games.Mickey = (function () {
        ...
        function initialize(view) {
            view.collection = new Marks([
                ...
                { value: '14', players: view.options.players },
                { value: '13', players: view.options.players },
                { value: '12', players: view.options.players },
                { value: 'T', players: view.options.players },
                { value: 'D', players: view.options.players },
                { value: 'B', players: view.options.players }
            ]);
